(defproject clientex "0.1.0"
  :description "ClojureScript client only Hanami example app"
  ...
  :cljsbuild {:builds
              [{:id "dev"
                ...
                ;; into your build
                :figwheel {;;:on-jsload "clientex.core/on-js-reload"
                ...
                :compiler {:main clientex.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/clientex.js"
               ...
               {:id "min"
                :source-paths ["src/cljs"]
                :compiler {:output-to "resources/public/js/compiled/clientex.js"
                           :main clientex.core
